...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = 'Khmer Dubbed Repository'
BUILDERNAME = 'Ka0tiix'
EXCLUDES = [ADDON_ID, 'repository.ka0tiix']
# Text File with build info in it.
BUILDFILE = 'http:// ENTER DOMAIN URL FOR BUILDS FILE/builds.txt'
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]ENTER WIZARD NAME[/B][/COLOR][COLOR {color2}]Wizard[COLOR {color1}])[/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
HIDECONTACT = 'No'
# You can add \n to do line breaks
CONTACT = 'Thank you for choosing Ka0tiix.\n\nContact us at sin.chuon@gmail.com'
...
REPOID = 'repository.ka0tiix'
# Url to Addons.xml file in your repo folder(this is so we can get the latest version)
REPOADDONXML = 'https://github.com/Ka0tiix/KDR/zips/addons.xml'
# Url to folder zip is located in
REPOZIPURL = 'https://github.com/Ka0tiix/KDR/zips/repository.ka0tiix/'
#########################################################
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR red][B]Ka0tiix's[/B][/COLOR] KDR'
